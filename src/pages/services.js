...
export default function Services() {
    ...
    const Offer = (props) => {
        return (
            <div className="card my-3 text-center pt-4" style={{ width: "20vw"}}>
    ...
    return (
        <>
            ...
            <div className="d-flex flex-row mb-5 justify-content-center gap-3">
                <Offer icon="bi bi-brush text-primary" name="UX Design" description="L'UX design est une discipline qui consiste à concevoir des produits (sites web,
                ...
                <Offer icon="bi bi-code-slash text-primary" name="Développement web" description="Le développement web de sites web consiste à créer des sites internet 
                en utilisant des langages de programmation (HTML, CSS, JavaScript, PHP, etc.) et des frameworks (Bootstrap, React, Angular, etc.)." />
                <Offer icon="bi bi-search text-primary" name="Référencement" description="Le référencement naturel (SEO) est une technique qui consiste à optimiser un site web 
